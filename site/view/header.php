        ...
        <header class="header header_menu container px-md-0">
            <div class="row align-items-center">
                <nav class="header__navbar">
                    <div class="navbar__logo col-4 col-lg-2 header-right">
                        <a href="?modules=page&action=home" class="navbar__logo-wrap">
                            <img src="../../content/img/logo.png" alt="Logo">
                        </a>
                    </div>

                    <div class="navbar__search col-xl-5 col-lg-4 col-12 header-center">
                    ...
                    <div class="navbar__info col-4 col-xl-5 col-lg-6">
